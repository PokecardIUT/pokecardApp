...
class ChooseCardViewHolder(var v: View): RecyclerView.ViewHolder(v) {

    private val cardImageView: ImageView = itemView.findViewById(R.id.adapter_card_create_set_card)
